...
export type Product = { id: string; category_id: string; name: string; slug: string; description: string; price: number | null; price_label?: string | null; image_url: string | null; origin: string | null; dimensions: string | null; care: string | null; whatsapp_url: string | null; display_order: number; active: boolean; categories?: Pick<Category, 'name' | 'slug'> | null; variants?: ProductVariant[] };
